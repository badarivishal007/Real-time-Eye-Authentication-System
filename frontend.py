...
ima = PhotoImage(file = 'C:\\Users\\user\\Desktop\\Raspberry-Face-Recognition-master\\a.png')
...
##    window.configure(background ="brown")
    ...
    ima = PhotoImage(file = 'C:\\Users\\user\\Desktop\\Raspberry-Face-Recognition-master\\111.png')
    ...
    button1=Button(window,text="Training faceid",command=fun1,width=20,font=("Century Gothic",24,"bold","italic"),foreground="white",bg="black")
